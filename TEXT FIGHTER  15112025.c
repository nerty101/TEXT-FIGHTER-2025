...
dice1 = (rand() % 80 + cpusp2 + diflev) + 1;//was 7 now 70 80
...
if (new6 > 0)
printf("\n     You've got a Consecutive Match Win Record!");
if ((cpulow > 0) && (new6 > 0))
printf("\n");
if ((cpulow < 1) && (new6 > 0))
...
if ((magchn > 2) && (posmag > 0))
{
if ((magchn > 2) && (magchn > magrec2))
magrec = magchn;
if (magrec > magrec2)
{
++new8;
...
if (diceQ == 2)
printf("     An amazing magic attack!\n");
if (diceQ == 3)
...
if (playerhp < 1)
printf("\n");
if ((emagsup > 0) || (emagsup5 > 0))///new 06112025
{
diceR = (rand() % 6) + 1;
if (diceR == 1)
{
...
if ((supspatt2 < 1) || (diceM < 41) || (f > 0) || (e < 1) || (d > 0) || (emagsup > 0) || (emagsup5 > 0))
{
magdup = 0;
}
if ((spatt2 < 1) || (diceM < 41) || (f > 0) || (e > 0) || (d < 1) || (emagsup > 0) || (emagsup5 > 0))
{
magdup2 = 0;
}
if (((diceM > 40) && (diceB >= 4) && (diceB <= 6)) && (playerhp > 0) && (hypsp2 < 1))
{
{
++g;
++g2;
...
if ((diceN < 41) || (f > 0) || (e > 0) || (d > 0) || (mspatt3 < 1) || (mspatt4 < 1) || (emagsup < 1))
{
magdup3 = 0;
}
if ((emgspcom4 == 1) && (f < 1) && (e < 1) && (d < 1) && ((diceN > 40) && (diceB >= 4) && (diceB <= 6)) && ((diceM > 40) && (diceB >= 4) && (diceB <= 6)) && ((mspatt3 > 0) && (mspatt4 > 0)) && (emagsup > 0))
{
++magdup3;
if (magdup3 == 1)
...
if ((diceP < 41) || (f > 0) || (e > 0) || (d > 0) || (mspatt3 < 1) || (mspatt4 < 1) || (mspatt5 < 1) || (emagsup < 1) || (emagsup5 < 1))
{
magdup4 = 0;
}
if ((emgspcom3 == 1) && (f < 1) && (e < 1) && (d < 1) && ((diceP > 40) && (diceB >= 4) && (diceB <= 6)) && ((diceN > 40) && (diceB >= 4) && (diceB <= 6)) && ((diceM > 40) && (diceB >= 4) && (diceB <= 6)) && ((mspatt3 > 0) && (mspatt4 > 0) && (mspatt5 > 0)) && (emagsup > 0) && (emagsup5 > 0))
{
++magdup4;
if (magdup4 == 1)
